...
// method to add elements of anotherQueue to this queue
public void splice(QueueInterface<T> anotherQueue)
{
// loop that continues until anotherQueueis empty, inserting elements of anotherQueue to this queue at the end
